<%-- 
    Document   : xh
    Created on : 2014-11-22, 22:47:40
    Author     : chenqian
--%>
...
<body class="zhi">
    ...
    <br
    <div style="height:50px"><a href="xh.jsp"><h1 align="center">协会风采</h1></a></div>
...
<div id="zh-recommend">
    ...
    String sql3="select * from article where topicname='xh'  order by count desc";
...
<%  DbBean db1 =new DbBean();
    String sql1="select * from article where topicname='xh'order by data desc";
