...
<body class="zhi">
    ...
    <div style="height:60px"><a href="xs.jsp"><h1 align="center">学术组织</h1></a></div>
...
<div id="zh-recommend">
    ...
    String sql3="select * from article where topicname='xs'  order by count desc";
...
<%  DbBean db1 =new DbBean();
    String sql1="select * from article where topicname='xs'order by data desc";
