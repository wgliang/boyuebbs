...
<%  DbBean db =new DbBean();
  ...
  %>
<li class="clearfix">
    <a target="_blank" class="avatar-link" href="topics/<%=rs.getString("topic_name")%>.jsp" data-tip="t$b$19781331">
     <img src="images/topics/<%=rs.getString("topic_name")%>.jpg" alt="<%=rs.getString("topic_name")%>" class="avatar 40" /></a>
            <div class="content">
                 <a href="topics/<%=rs.getString("topic_name")%>.jsp" target="_blank" data-tip="t$b$19781331">
