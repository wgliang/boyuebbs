<%-- 
    Document   : ping
    Created on : 2014-11-22, 22:48:52
    Author     : chenqian
--%>
...
<body class="zhi">
    ...
    <br>
    <div style="height:50px"><a href="ping.jsp"><h1 align="center">拼客</h1></a></div>  <%--  这里放张图片链接 --%>
...
<div id="zh-recommend">
    ...
    String sql3="select * from article where topicname='ping'  order by count desc";
...
<%  DbBean db1 =new DbBean();
    String sql1="select * from article where topicname='ping' order by data desc";
